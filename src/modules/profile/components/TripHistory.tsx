            ...
            <Card className="p-4 flex flex-col gap-3">
              <div className="flex justify-between items-start">
                <div className="flex flex-col">
                  <Badge className="mb-2 w-fit">Revision</Badge>
                  <h4 className="font-bold">Documento de onboarding</h4>
              ...
              <div className="flex items-center gap-2">
                <Avatar className="w-6 h-6">
                  <AvatarImage
                    ...
                    alt="Miniatura de Camila"
                  />
                  <AvatarFallback>S</AvatarFallback>
                </Avatar>
                <span className="text-sm text-foreground">Por Camila</span>
            ...
            <Card className="p-4 flex flex-col gap-3">
              <div className="flex justify-between items-start">
                <div className="flex flex-col">
                  ...
                  <h4 className="font-bold">Guia de integracion</h4>
                  <p className="text-sm text-muted-foreground">
                    Oct 22 • 06:15 PM
                  </p>
                </div>
